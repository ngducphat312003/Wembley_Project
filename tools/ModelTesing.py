    ...
    for i, det in enumerate(pred):
        ...
        if len(det):
            ...
            for j, (*xyxy, conf, cls) in enumerate(reversed(det)):
                ...
                cropped_img = img0[xyxy[1]:xyxy[3]+3, xyxy[0]:xyxy[2]]
...
def setup_ad():
    ...
    # memory_banktr = torch.load(r"H:\HK242\LVTN\Model\blackplastic1\memory_banktrv1_3.pt").cuda()
    ...
    # return backbone, memory_bankbl, memory_bankbr, memory_bankmid, memory_banktl, memory_banktr, transform
